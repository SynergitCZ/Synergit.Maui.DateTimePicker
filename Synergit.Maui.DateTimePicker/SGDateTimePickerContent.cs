...
internal class SGDateTimePickerContent : ContentView
{
    ...
    readonly ISGDateTimePickerOptions _options;
    ...
    internal SGDateTimePickerContent(ISGDateTimePickerOptions options)
    {
        base.Padding = 0;
        base.Margin = 0;
        options ??= new SGDateTimePickerOptions();
